(function() {
	...
	app.Page({
		pageId: 'finance-diamondRecord',
		data: {
			systemId: 'finance',
			moduleId: 'diamondRecord',
		...
		methods: {
			...
			toBuy:function(){
				app.navTo('../../finance/recharge/recharge');
			},
			screen:function(e){
			...
			getList:function(loadMore){
				...
				app.request('//diamondapi/getMyDiamondLog',formData,function(backData){
