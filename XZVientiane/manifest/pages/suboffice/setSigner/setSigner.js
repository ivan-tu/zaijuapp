    ...
    app.Page({
        ...
        methods: {
			...
			getList:function(loadMore){
				...
				app.request('//clubapi/getClubSigner',formData,function(backData){
				...
				app.actionSheet(listArray,function(num){
					switch(listArray[num]){
						...
						app.confirm('确定要移除吗？',function(){
							app.request('//clubapi/delClubSigner',{id:id},function(){
				...
				if(msg){
					...
					app.request('//userapi/getInfoByAccount',{account:formData.account},function(res){
						if(res&&res._id){
							...
							app.request('//clubapi/addClubSigner',formData,function(){
