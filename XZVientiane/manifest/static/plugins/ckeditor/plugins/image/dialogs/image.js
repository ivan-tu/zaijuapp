                                                                ...
                                                                children: [
                                                                        {
                                                                                ...
                                                                                children: [
                                                                                        ...
                                                                                        },
                                                                                        {
                                                                                                ...
                                                                                                align: 'center',
                                                                                                hidden: typeof top.openFinder != 'function'&&typeof xzUpload=='function' ? false : true,
                                                                                                ...
                                                                                                onClick: function() {
																										...
																										var opts={
																											...
																											callBack:function(data) {
																													 urlInput.setValue(getThumbImageView(data[0].src,600,9999));
																													 urlInput.onChange();
																											}
																										};
																										if(editor.uploadOpts){
																											opts=$.extend(true,opts,editor.uploadOpts);
																										};
																										top.xzUpload(opts);	
                                                                                                }
                                                                                        },
                                                                                        {
                                                                                                ...
                                                                                                align: 'center',
                                                                                                hidden: typeof top.openFinder == 'function' ? false : true,
                                                                                                label: editor.lang.common.selectFile,
                                                                                                onClick: function() {
                                                                                                        top.openFinder(function(data) {
                                                                                                                urlInput.setValue(getThumbImageView(data[0].src,600,9999));
                                                                                                                urlInput.onChange();
                                                                                                        });
                                                                                                }
                                                                                ...
                                                                                children: [
                                                                                        {
                                                                                                ...
                                                                                                html: '<div>' + CKEDITOR.tools.htmlEncode(editor.lang.common.preview) + '<br>' +
                                                                                                        ...
                                                                                                        (editor.config.image_previewText || 'image preview text.') +
                                                                                                        '</td></tr></table></div></div>'
                                                                                        }
                                                                                ]
                                                                        }
                                        ...
                                        },
                                        {
                                                ...
                                                elements: [
                                                        ...
                                                        },
                                                        {
                                                                type: 'button',
                                                                id: 'selectPageText',
                                                                hidden: typeof top.selectPageUrl == 'function' ? false : true,
                                                                label: editor.lang.common.selectPage,
                                                                style: 'margin-top:10px;margin-bottom:10px;',
                                                                onClick: function() {
                                                                        top.selectPageUrl('', function(data) {
                                                                                hrefInput.setValue(data.href);
                                                                        });
                                                                }
                                                        },
                                                        {
