...
- (void)loadImage {
    ...
    // 开始加载
    UIImage *cacheImage = [[SDImageCache sharedImageCache] imageFromCacheForKey:self.url.absoluteString];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (error) {
                ...
                if (cacheType == SDImageCacheTypeNone) {
                    ...
                    NSData *imageData = [[SDImageCache sharedImageCache] diskImageDataForKey:wself.url.absoluteString];
