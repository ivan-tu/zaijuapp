...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [UIApplication sharedApplication].statusBarStyle = iOS8Later ? UIStatusBarStyleLightContent : UIStatusBarStyleBlackOpaque;
}
...
- (void)playButtonClick {
    ...
    if (_player.rate == 0.0f) {
        ...
        if (iOS8Later) [UIApplication sharedApplication].statusBarHidden = YES;
    } else {
...
- (void)pausePlayerAndShowNaviBar {
    ...
    if (self.needShowStatusBar && iOS8Later) {
